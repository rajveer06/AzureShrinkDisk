# Variables
$DiskID = "/subscriptions/6b404b00-c798-432c-8618-d3447c0f1ffd/resourceGroups/CT-TESTING/providers/Microsoft.Compute/disks/octopus_testingOsDisk"
$VMName = "testVm"
$DiskSizeGB = 64
$AzSubscription = "Microsoft - Pay-As-You-Go"
